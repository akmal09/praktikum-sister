...
if (a.acceleration.x - ax_offset <= -1) {
Serial.println("kuning hidup buzzer mati");
...
if (a.acceleration.x - ax_offset >= 1) {
  Serial.println("kuning hidup buzzer hidup");
digitalWrite(KUNING, HIGH);
digitalWrite(HIJAU, LOW);
digitalWrite(BIRU, LOW);
tone(BUZZER, 293);
...
if (a.acceleration.y - ay_offset >= 1) {
  Serial.println("biru hidup buzzer mati");  
...
if (a.acceleration.y - ay_offset <= -1) {
    Serial.println("biru hidup buzzer hidup");
digitalWrite(BIRU, HIGH);
digitalWrite(KUNING, LOW);
digitalWrite(HIJAU, LOW);
tone(BUZZER, 293);
...
if (a.acceleration.z - az_offset >= 10) {
    Serial.println("hijau hidup buzzer mati");
...
if (a.acceleration.z - az_offset <= 8) {
    Serial.println("hijau hidup buzzer hidup");
digitalWrite(HIJAU, HIGH);
digitalWrite(KUNING, LOW);
digitalWrite(BIRU, LOW);
tone(BUZZER, 293);
